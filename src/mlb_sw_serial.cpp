...
#define MLB_CPP_WRAPPER_CPP_CLASS SoftwareSerial
  ...
  MLB_CPP_WRAPPER_DEF(void, mlb_sw_serial_begin, begin, long, speed)
  MLB_CPP_WRAPPER_DEF(void, mlb_sw_serial_end, end)
  MLB_CPP_WRAPPER_DEF(bool, mlb_sw_serial_listen, listen)
  MLB_CPP_WRAPPER_DEF(bool, mlb_sw_serial_is_listening, isListening)
  MLB_CPP_WRAPPER_DEF(bool, mlb_sw_serial_stop_listening, stopListening)
  MLB_CPP_WRAPPER_DEF(bool, mlb_sw_serial_overflow, overflow)
